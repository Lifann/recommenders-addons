...
#
# ```python
# cached_tf_function = tf.function
# tf.function = replace_tf_function()
#
# class DynamicEmbeddingFuncion(object):
#   def __init__(self, func, **kwargs):
#     self.func = cached_tf_function(func=None, **kwargs)(func)
#
#   def __call__(self, *args, **kwargs):
#     return self.func(*args, **kwargs)
# ```
#
# In outermost scope, the function needs to set the attributes
# if it returns the trainable objects, by backtracing the
# funciton calling stack.
